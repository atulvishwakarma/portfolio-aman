    ...
    <div className='business-page'>
      <div className='business-container container max-w-full px-4'>
        ...
        <div className='business-image'>
            <img src={amanprofile} alt="amanprofile" className='w-32 h-32 md:w-52 md:h-auto rounded-full shadow-2xl -mt-24'/>
          </div>
          <div className='business-content text-center'>
            ...
            <div className='business-description text-lg  text-slate-500 dark:text-slate-300'>
             <p> Lorem ipsum dolor sit amet consectetur, adipisicing elit. Exercitationem voluptate similique, nisi molestiae veritatis eius in animi blanditiis officia hic rem id nemo rerum dolorem ullam, iste, omnis natus deleniti.</p>
            </div>
          </div>
        </div>
